...
' // Begin HCCSC Header
' //  Added to HCCSC Production Environment May 4,2016 by J Ryan Wall
'
' // Added following model/vendors to script and date of addition
'	HP Compaq dc5700 Small Form Factor -> dc5700 (May 4, 2016)
'   HP Compaq dc5800 Small Form Factor -> dc5800 (May 4, 2016)
'   Hewlett-Packard -> HP (May 4, 2016)
'
' // End HCCSC Header
...
Function SetModelAlias()
    ...
    Case "Hewlett-Packard"
		...
		Select Case sModel
			...
			Case "HP EliteBook 8560w Hewlett Packard"
				SetModelAlias = "HP EliteBook 8560w"
			Case "HP Compaq dc5800 Small Form Factor"
				SetModelAlias = "dc5800"
			Case "HP Compaq dc5700 Small Form Factor"
				SetModelAlias = "dc5700"
			Case Else
				SetModelAlias = sModel 
	...
	Case "HP"
			...
			Case "HP EliteDesk 800 G2 SFF"
				SetModelAlias = "EliteDesk 800"
				
			Case "HP ProBook 430 G5"
				SetModelAlias = "ProBook 430 G5"

			Case "HP EliteDesk 800 G3 DM 35W"
				SetModelAlias = "EliteDesk 800 G3 Mini"
